...
namespace UKHO.MaritimeSafetyInformation.Web.Services
{
    public class RnwService : IRnwService
    {
        ...
        public RadioNavigationalWarningsAdminList EditRadioNavigationWarningListForAdmin(int id)
        {
            try
            {
        ...
        public async Task<bool> EditNewRadioNavigationWarningsRecord(RadioNavigationalWarningsAdminList radioNavigationalWarning, string correlationId)
        {
