...
namespace UKHO.MaritimeSafetyInformation.Web.Services.Interfaces
{
    public interface IFileShareServiceCache
    {
        ...
        Task<BatchSearchResponseModel> GetWeeklyBatchFilesFromCache(int year, int week, string correlationId);

        Task InsertEntityAsync(object data, string rowKey, string tableName);
    }
}
