...
namespace UKHO.MaritimeSafetyInformation.Web.Controllers
{
    public class RadioNavigationalWarningsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,WarningType,Reference,DateTimeGroup,Description,Text,ExpiryDate,ApprovalStatus,IsDeleted")] RadioNavigationalWarnings radioNavigationalWarnings)
        {
