...
namespace UKHO.MaritimeSafetyInformation.IntegrationTests.RadioNavigationalWarning
{
    public class BaseRNWTest
    {
        ...
        public static radioNavigationalWarningDto.RadioNavigationalWarning GetFakeRadioNavigationalWarning()
        {
            return new radioNavigationalWarningDto.RadioNavigationalWarning()
            {
