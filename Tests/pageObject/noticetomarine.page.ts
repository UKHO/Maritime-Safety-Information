...
export default class noticetoMarine
{
    ...
    constructor(page:Page)
    {
     ...
     this.menuNoticeToMarine = this.page.locator('#headingLevelOne text=Notices to Mariners');
     this.menuLeisureFolios = this.page.locator('#headingLevelOne text=Leisure Folios');
     this.menuValueAddedResellers = this.page.locator('#headingLevelOne text=Value Added Resellers');
     this.menuAbout = this.page.locator('#headingLevelOne text=About');
